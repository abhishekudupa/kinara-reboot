...
if(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
  if(CXX_COMPILER_VERSION VERSION_LESS "4.8.1")
    ...
    message(STATUS "Using g++ ${CXX_COMPILER_VERSION} as the c++ compiler in C++11 mode")
  endif()
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  if(CXX_COMPILER_VERSION VERSION_LESS "3.3")
    message(FATAL_ERROR, "Kinara requires clang++ 3.3 or later")
  else()
    message(STATUS "Using clang++ ${CXX_COMPILER_VERSION} as the c++ compiler in C++11 mode")
  endif()
else()
