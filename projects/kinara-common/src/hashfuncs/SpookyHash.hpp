...
private:
    ...
    //
    static constexpr uint64 sc_const = (uint64)0xdeadbeefdeadbeefULL;
...
static inline u32 spooky_hash_32(const void* data, u64 length, u32 seed)
{
    return spooky_hash_detail_::SpookyHash::Hash32(data, length, seed);
}

static inline u32 spooky_hash_32(const void* data, u64 length)
{
    // predefined prime number as seed
    static constexpr u32 seed = (u32)2038074751;
    return spooky_hash_detail_::SpookyHash::Hash32(data, length, seed);
}

static inline u64 spooky_hash_64(const void* data, u64 length, u64 seed)
{
    return spooky_hash_detail_::SpookyHash::Hash64(data, length, seed);
}

static inline u64 spooky_hash_64(const void* data, u64 length)
{
    // predefined prime number as seed
    static constexpr u64 seed = (u64)18446744073709551557ULL;
    return spooky_hash_64(data, length, seed);
}

static inline u128 spooky_hash_128(const void* data, u64 length,
                                   u64 seed1, u64 seed2)
{
    spooky_hash_detail_::SpookyHash::Hash128(data, length, &seed1, &seed2);
    return std::make_pair(seed1, seed2);
}

static inline void spooky_hash_128(const void* data, u64 length,
                                   u64* seed1, u64* seed2)
{
    spooky_hash_detail_::SpookyHash::Hash128(data, length, seed1, seed2);
}
                                      ...
                                      const u128& seed)
{
    ...
    spooky_hash_detail_::SpookyHash::Hash128(data, length, &(actual_seed.first),
                                             &(actual_seed.second));
    return actual_seed;
}
...
{
    u128 retval;
    retval.first = (u64)9223372036854775783ULL;
    retval.second = (u64)18446744073709551557ULL;
    spooky_hash_detail_::SpookyHash::Hash128(data, length, &(retval.first),
                                             &(retval.second));
    return retval;
}
